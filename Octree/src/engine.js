class Engine{
   ...
   addPoint() {
      var x = parseInt(document.getElementById('coordX').value);
      var y = parseInt(document.getElementById('coordY').value);
      var z = parseInt(document.getElementById('coordZ').value);
